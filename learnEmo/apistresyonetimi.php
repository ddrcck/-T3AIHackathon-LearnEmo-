...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!isset($_SESSION['conversation_history'])) {
        $_SESSION['conversation_history'] = [
            ["role" => "system", "content" => "Sen çocuklar için stres yönetimi ve mindfulness önerileri yapan bir asistansın. Çocuklara streslerini azaltmalarına yardımcı olacak basit ve anlaşılır öneriler vereceksin."]
        ];
    }
